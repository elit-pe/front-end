  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: process.env.PUBLIC_URL + 'assets/img/brand/logo_easybuy.jpg', width: 89, height: 25, alt: 'CoreUI Logo' }}
        ...
        <Nav className="ml-auto" navbar>
          ...
          <AppHeaderDropdown direction="down">
            <DropdownToggle nav>
              <img src={'assets/img/avatars/akira.jpg'} className="img-avatar" alt="Akira" />
            </DropdownToggle>
