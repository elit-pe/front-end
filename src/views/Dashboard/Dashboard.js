...
const mainChart = {
  labels: ['Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab', 'Dom'],
  datasets: [
    {
      label: 'My First dataset',
  ...
  render() {
    return (
      <div className="animated fadeIn">
              ...
              <CardBody>
                <Row>
                  <Col sm="5">
                    ...
                    <div className="small text-muted">Junho 2018</div>
                  </Col>
              ...
              <CardFooter>
                <Row className="text-center">
                  ...
                  <Col sm={12} md className="mb-sm-2 mb-0 d-md-down-none">
                    <div className="text-muted">Acessos</div>
                    <strong>24.093 Usuários (20%)</strong>
                    <Progress className="progress-xs mt-2" color="info" value="20" />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    <div className="text-muted">Visualizações</div>
                  ...
                  <Col sm={12} md className="mb-sm-2 mb-0 d-md-down-none">
                    <div className="text-muted">Porcentagem</div>
                    <strong>Rate (40.15%)</strong>
        ...
        <Row>
          <Col xs="6" sm="6" lg="3">
            <Widget03 dataBox={() => ({ variant: 'facebook', Amigos: '89k', feeds: '459' })} >
            ...
            <div className="brand-card">
              ...
              <div className="brand-card-body">
                <div>
                  ...
                  <div className="text-uppercase text-muted small">Seguidores</div>
                </div>
                <div>
            ...
            <div className="brand-card">
              ...
              <div className="brand-card-body">
                <div>
                  ...
                  <div className="text-uppercase text-muted small">contatos</div>
                </div>
                <div>
            ...
            <div className="brand-card">
              ...
              <div className="brand-card-body">
                ...
                <div>
                  ...
                  <div className="text-uppercase text-muted small">circulos</div>
                </div>
              </div>
            </div>
          </Col>
